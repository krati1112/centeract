...
public class Sms extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ((Button)findViewById(R.id.topsend)).setOnClickListener(onButtonClick);
        ((Button)findViewById(R.id.back)).setOnClickListener(onButtonClick);
